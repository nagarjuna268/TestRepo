...
/*
	        ...
	        out.write("<table  border=1 cellspacing=1 cellpadding=1 >");
	    	out.write("<tr>");
	        out.write("<td width=80  align= left  bgcolor=#153E7E><FONT COLOR=#E0E0E0 FACE= Arial  SIZE=2><b>Test Script#</b></td>");

	        out.write("<td width=300 align= left  bgcolor=#153E7E><FONT COLOR=#E0E0E0 FACE= Arial  SIZE=2><b>Test Case Name</b></td>");
	        out.write("<td width=75 align= left  bgcolor=#153E7E><FONT COLOR=#E0E0E0 FACE= Arial  SIZE=2><b>Status</b></td>");
	        out.write("<td width=200 align= left  bgcolor=#153E7E><FONT COLOR=#E0E0E0 FACE= Arial  SIZE=2><b>Run End Time</b></td>");
	        out.write("</tr>");
	   */
    ...
    public static void startSuite(String suiteName){
    	...
    	out.write("<tr>\n");
    	out.write("<td width=10% align= center  bgcolor=#153E7E><FONT COLOR=#E0E0E0 FACE= Arial  SIZE=2><b>Browser Name</b></td>\n");
	...
	public static void addTestCase(String browser,String testCaseName,String testCaseStartTime,String testCaseEndTime,String status){
		newTest=true;
		FileWriter fstream=null;
		BufferedWriter out=null;
		 				...
		 				out.write("<td width=20% align= left  bgcolor=#d3d3d3><FONT COLOR=#153E7E FACE=Arial SIZE=2><b>"+teststatus.get(i)+"</b></td>\n");
		 			  	...
		 			  	/*if(screenShotPath.get(i) != null)
				 			 out.write("<td align=left width=20%><FONT COLOR=#153E7E FACE=Arial SIZE=1><b><a href="+screenShotPath.get(i)+" target=_blank>Screen Shot</a></b></td>");
				 				...
				 				out.write("<td align=left width=20%><FONT COLOR=#153E7E FACE=Arial SIZE=1><b>&nbsp;</b></td>");	 
				 			 out.write("</tr>");*/
		 			}
		 			// out.write("<td align=left width=20%><FONT COLOR=#153E7E FACE=Arial SIZE=1><b>"+teststatus.get(i)+"</b></td>");
